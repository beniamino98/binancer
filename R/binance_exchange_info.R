...
#'   - `"spot"`: for endpoint [api/v3/exchangeInfo](https://developers.binance.com/docs/binance-spot-api-docs/rest-api/general-endpoints#exchange-information). The ip weight is 20.
#'   - `"fapi"`: for endpoint [fapi/v1/exchangeInfo](https://developers.binance.com/docs/derivatives/usds-margined-futures/market-data/rest-api/Exchange-Information). The ip weight is 1.
#'   - `"dapi"`: for endpoint [dapi/v1/exchangeInfo](https://developers.binance.com/docs/derivatives/coin-margined-futures/market-data/rest-api/Exchange-Information). The ip weight is 1.
#'   - `"eapi"`: for endpoint [eapi/v1/exchangeInfo](https://developers.binance.com/docs/derivatives/option/market-data/Exchange-Information). The ip weight is 1.
