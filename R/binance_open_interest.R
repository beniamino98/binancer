...
#'   - `"fapi"`: for endpoint [fapi/v1/openInterestHist](https://developers.binance.com/docs/derivatives/usds-margined-futures/market-data/rest-api/Open-Interest-Statistics). The ip weight is 0.
#'   - `"dapi"`: for endpoint [dapi/v1/openInterestHist](https://developers.binance.com/docs/derivatives/coin-margined-futures/market-data/rest-api/Open-Interest-Statistics). The ip weight is 0.
#' @param interval Character. Time interval for open interest data. Default is `"1h"`. Available intervals are: 
...
#' If it is `missing`, the default, will be used as start date  \code{\link[=Sys.time]{Sys.time()}}.
...
#' 
#' @return A \code{\link[tibble]{tibble}} with 5 columns:
...
#' binance_open_interest(pair = "BTCUSD", 
#'                       api = "dapi", 
#'                       interval = "1d", 
#'                       from = Sys.time()-lubridate::days(15),
#'                       to = NULL)
...
#' @export
binance_open_interest <- function(pair, api, interval, from, to, contract_type, quiet = FALSE){
